...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="TOOP EDM Rules (specs Version 2.0.0)">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>TOOP EDM Rules (specs Version 2.0.0)</svrl:text>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryResponse/rs:Exception" mode="M18" priority="1000">
...
<xsl:choose>
    ...
    <xsl:variable name="countExceptionPublicOrganizationIdentifier" select="count(rim:Slot[@name = 'PublicOrganizationIdentifier'])" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="( ($countExceptionPublicOrganizationIdentifier=0) or ($countExceptionPublicOrganizationIdentifier=1) )" />
      <xsl:otherwise>
        <svrl:failed-assert test="( ($countExceptionPublicOrganizationIdentifier=0) or ($countExceptionPublicOrganizationIdentifier=1) )">
          <xsl:attribute name="id">exc_card_PublicOrganizationIdentifier</xsl:attribute>
          <xsl:attribute name="flag">ERROR</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>
                Each Exception must contain ZERO or ONE PublicOrganizationIdentifier slots (found: <xsl:text />
            <xsl:value-of select="$countExceptionPublicOrganizationIdentifier" />
            <xsl:text />).  
            </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/rim:Slot[@name = 'DataConsumer']" mode="M19" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/rim:Slot[@name = 'DataConsumer']/rim:SlotValue/cagv:Agent" mode="M20" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="($countLocation=0) or ($countLocation=1)">
          ...
          <svrl:text>
                The Agent must contain ZERO or ONE Location elements (found: <xsl:text />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/query:Query" mode="M21" priority="1000">
    <svrl:fired-rule context="query:QueryRequest/query:Query" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="( (exists(rim:Slot[@name = 'ConceptRequestList'])) or (exists(rim:Slot[@name = 'DistributionRequestList'])) )" />
      <xsl:otherwise>
        <svrl:failed-assert test="( (exists(rim:Slot[@name = 'ConceptRequestList'])) or (exists(rim:Slot[@name = 'DistributionRequestList'])) )">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/query:Query/rim:Slot[@name = 'ConceptRequestList']" mode="M22" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/query:Query/rim:Slot[@name = 'DistributionRequestList']" mode="M23" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rim:Slot/rim:SlotValue/cva:CorePerson" mode="M24" priority="1000">
    <svrl:fired-rule context="rim:Slot/rim:SlotValue/cva:CorePerson" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/query:Query/rim:Slot[@name = 'ConceptRequestList']/cccev:Concept                       |query:QueryResponse/rim:RegistryObjectList/rim:RegistryObject/rim:Slot/rim:SlotValue/rim:Element/cccev:Concept" mode="M25" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="($countconcepts > 0)">
          ...
          <svrl:text>
                The Concept must contain at least ONE concepts element (found: <xsl:text />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryRequest/query:Query/rim:Slot[@name = 'ConceptRequestList']//cccev:concept                       |query:QueryResponse/rim:RegistryObjectList/rim:RegistryObject/rim:Slot/rim:SlotValue/rim:Element//cccev:concept" mode="M26" priority="1000">
    <svrl:fired-rule context="query:QueryRequest/query:Query/rim:Slot[@name = 'ConceptRequestList']//cccev:concept                       |query:QueryResponse/rim:RegistryObjectList/rim:RegistryObject/rim:Slot/rim:SlotValue/rim:Element//cccev:concept" />
    <xsl:variable name="countConceptId" select="count(cbc:id)" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:Query/rim:Slot[@name = 'DistributionRequestList']/rim:SlotValue/rim:Element/dcat:Distribution" mode="M27" priority="1000">
    <svrl:fired-rule context="query:Query/rim:Slot[@name = 'DistributionRequestList']/rim:SlotValue/rim:Element/dcat:Distribution" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rim:Slot/rim:SlotValue/cva:CoreBusiness" mode="M28" priority="1000">
    <svrl:fired-rule context="rim:Slot/rim:SlotValue/cva:CoreBusiness" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="//cva:PersonCoreAddress | //cva:LegalEntityCoreAddress" mode="M29" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryResponse/rim:Slot[@name = 'DataProvider']" mode="M30" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryResponse/rim:RegistryObjectList/rim:RegistryObject" mode="M31" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryResponse/rim:RegistryObjectList/rim:RegistryObject/rim:Slot[@name = 'ConceptValues']" mode="M32" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="query:QueryResponse/rim:RegistryObjectList/rim:RegistryObject/rim:Slot/rim:SlotValue/dcat:Dataset" mode="M33" priority="1000">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="//cccev:value" mode="M34" priority="1000">
    ...
    <xsl:variable name="counterror" select="count(cccev:error)" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="($countamountValue+$countcodeValue+$countdateValue+$countidentifierValue+$countindicatorValue+$countnumericValue+$counttextValue+$counturiValue+$countperiodValue+$counterror=1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="($countamountValue+$countcodeValue+$countdateValue+$countidentifierValue+$countindicatorValue+$countnumericValue+$counttextValue+$counturiValue+$countperiodValue+$counterror=1)">
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="             rim:Slot[@name = 'SpecificationIdentifier']/rim:SlotValue             | rim:Slot[@name = 'ConsentToken']/rim:SlotValue              | rim:Slot[@name = 'DatasetIdentifier']/rim:SlotValue             " mode="M35" priority="1005">
    <svrl:fired-rule context="             rim:Slot[@name = 'SpecificationIdentifier']/rim:SlotValue             | rim:Slot[@name = 'ConsentToken']/rim:SlotValue              | rim:Slot[@name = 'DatasetIdentifier']/rim:SlotValue             " />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="             rim:Slot[@name = 'Procedure']/rim:SlotValue             | rim:Slot[@name = 'ErrorText']/rim:SlotValue/rim:Element              " mode="M35" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="             rim:Slot[@name = 'IssueDateTime']/rim:SlotValue             | rim:Slot[@name = 'Timestamp']/rim:SlotValue             " mode="M35" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="             rim:Slot[@name = 'ConceptRequestList']/rim:SlotValue             | rim:Slot[@name = 'DistributionRequestList']/rim:SlotValue             | rim:Slot[@name = 'ErrorText']/rim:SlotValue             " mode="M35" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="             rim:Slot[@name = 'ConceptRequestList']/rim:SlotValue             | rim:Slot[@name = 'DistributionRequestList']/rim:SlotValue             | rim:Slot[@name = 'ErrorText']/rim:SlotValue             " mode="M35" priority="1000">
    <svrl:fired-rule context="             rim:Slot[@name = 'ConceptRequestList']/rim:SlotValue             | rim:Slot[@name = 'DistributionRequestList']/rim:SlotValue             | rim:Slot[@name = 'ErrorText']/rim:SlotValue             " />
    <xsl:variable name="datatype" select="@*[ends-with(name(.), ':type') and . != '']" />
