    ...
    try
    {
      ...
      }
      {
        final IMicroElement ePartyInfo = eUserMessage.appendElement (NS_EBMS, "PartyInfo");
        {
          ...
          eFrom.appendElement (NS_EBMS, "PartyId").appendText (TCConfig.MEM.getMEMAS4TcPartyid ());
        ...
        }
        {
          ...
          eTo.appendElement (NS_EBMS, "PartyId").appendText (TCConfig.MEM.getMEMAS4GwPartyID ());
